...
public class RegisteredParticipantsEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registered_participants_events);
        ...
        String eventId = SharedPreferenceController.getSharedPreference(SharedPreferenceController.EVENT_ID_CONSTANT);
    ...
    private void sendDataRequest(final String EventId){
        ...
        StringRequest eventRequest = new StringRequest(
                Request.Method.POST,
                DataProvider.GET_EVENT_REGISTRATION,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();
                        Toast.makeText(RegisteredParticipantsEvents.this, "No Internet Connection",Toast.LENGTH_SHORT).show();
                    }
                }
        ){
            @Override
        ...
        eventRequest.setTag(DataProvider.GET_EVENT_REGISTRATION_TAG);
        ...
        progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialogInterface) {
                DataProvider.getInstance(RegisteredParticipantsEvents.this).cancelRequest(DataProvider.GET_EVENT_REGISTRATION_TAG);
            }
        });
